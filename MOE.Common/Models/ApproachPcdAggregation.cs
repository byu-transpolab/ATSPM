...
namespace MOE.Common.Models
{
    public class ApproachPcdAggregation : Aggregation
    {
        ...
        public double PlatoonRatio;                     //SRM

        public double TotalGreenTime;                               //SRM

        public double PercentGreen;                               //SRM

        public double TotalTime;                               //SRM

        public double TotalYellowTime;                               //SRM

        public double TotalRedTime;                               //SRM

        public double TotalVolume;                               //SRM
